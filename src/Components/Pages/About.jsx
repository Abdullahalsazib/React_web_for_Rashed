      ...
      >
        <div className=" space-y-3 w-[45%] flex items-center justify-between">
          <motion.div
            ...
            className=" w-[400px] h-[400px] dark:bg-red-800 bg-red-400"
          ></motion.div>
          <motion.div
            initial={{
              x: 300,
            ...
            className=" w-[40%]"
          >
            <h1 className=" text-[30px] font-semibold dark:text-white text-black">
              {" "}
              Lorem, ipsum dolor.
            </h1>
            <p className=" dark:text-white font-semibold text-[16px]">
